...
{% include figure image_path="assets/images/posts/2022/02/dopamine-detox-and-have-high-productivity/cover.jpg" alt="多巴胺 (Dopamine) 的活動機制" caption="多巴胺 (Dopamine) 的活動機制 (source: [Unsplash](https://unsplash.com/photos/FPt10LXK0cg))" %}
...
2020 年，[Social Dilemma (智能社會：進退兩難)](https://www.thesocialdilemma.com/) 在 Netflix 上映。即使是一個在科技業從業的工作者來說，剛看完這部片仍是充滿難以形容的震驚，且有如當頭棒喝。
...
短影音平台的盛行 (Tiktok, YouTube short) 就是個顯著利用人性與演算法密例子，也許你想著每則看似即時且短小的影音看著不會佔用太多時間，**殊不知隨著不斷推送感興趣的內容一直滑下去，就是一個小時以上**。明明都是相同的時間，但相較之下，要認真的運動一個小時，對多數人來說卻是極度的痛苦。
...
## 5 個社交應用軟體成癮現象 (常見於 Instagram、Facebook)
...
當我們積極做某件事情時，腦中會非常活躍的大量分泌。但當不足或失調時，則會令人失去控制肌肉的能力、導致注意力無法集中，在嚴重時能導致手腳不自主地顫動 (帕金森氏症, Parkinson's disease, PD)。
...
但也因此，多巴胺 (Dopamine) 在拉下拉桿的這項提示中，出現了預期下次行為操作獲得相同結果的渴望，使得活性於該階段中分泌活躍。但當未獲得預期的獎勵時，將降低其活性，像大腦發送負面的訊號，使得感到失落、情緒上受到影響。
...
如果想要了解自己是不是有存在社交軟體成癮，可以透過以下 5 個常見的規律了解自己是不是存在可能的手機、社交應用軟體成癮現象。

### 起床、半夜睡不著的第一件事就是查看手機社交媒體
...
我們的大腦天生設計傾向於選擇最簡單的任務，也許你只要留意都能注意到這些軟體花在介面上設計所下的功夫：
...
- 限時動態 (Instagram) 和閱後即焚 (Snapchat) 的設計，促使用戶主動發送時效性甚至存在私密級別的內容，甚至設計已讀和紅色小圈圈機制，以推送給關注者。同理，關注者擔心無法在時效性獲得私密性第一手消息，而不斷的要消除未讀的訊息以獲得滿足感。
...
Dopamine Fast (多巴胺禁食 / 多巴胺禁斷) 由 [Dr. Cameron Sepah](https://profiles.ucsf.edu/cameron.sepah) 提出，並且於臨床中應用於科技工作者或是風險資本家，目標是讓他們擺脫對某些刺激的依賴，例如電話提醒、短信和社交媒體通知。

辨別了六種主要的強迫性行為作為主要戒斷的目標 [^what-is-dopamine-detox]：
...
我認知到自己是一個非常重度的 Instagram 使用者，並且無時無刻地會關注他人的貼文。因此，自從在認識到自己的上癮習慣後，我在去年嘗試上面所提到的方式：

- Step 1：移除 Facebook App (因為鮮少使用，並且都轉移到網頁版)
- Step 2：關閉所有通知，包含 Line、Instagram、Twitter 等等，開始變成想到才去看一看訊息
- Step 3：設定 Screen Time，有意識的告訴自己花了很多時間在幾個 App 上 (但不可避免會手動取消，有時候還是會關掉限制打開 App)
- Step 4：取消遊戲和幾個會耗費大量時間但是沒什麼在用的訂閱 (例如：設定提醒取消 Amazon Prime、取消 Deliveroo 的外送會員計劃，減少花費大量時間選擇外送食物的行為)
- Step 5：設定 Email filter，退訂懶得看或是沒有質量的廣告、News Letter，不能退訂的就直接轉到垃圾信箱

並且，逐漸將社交軟體平台登出，甚至將 Instagram 移除。但仍不可避免仍克制不住想發動態的慾望，有時想要使用的時候會回到 App Store 上抓回來使用，**但相對變得麻煩許多**。

在這個時候開始，我嘗試了兩週後才回去使用 Instagram。在一開始確實充滿無聊，但在這個階段我嘗試將部分注意力轉移到吉他的練習和其他事物上 (延伸閱讀：[刻意練習 - 實踐刻意練習的 3 項原則，往專家的道路邁進，我的心得及實作](/peak-deliberate-practice-reading-feedback))。
...
**但看到這個畫面，就是告訴自己再無聊都不可以登進去**。當上述的重複幾次後，**我才發現原來自己會不自覺一天開啟這個頁面不下 5-10 次**，於是開始感到無聊，且覺得沒意義。

雖然結束後還是會跑回手機或是網頁版看看東西，但在體驗後發現好像對生活不會有太大的影響。並且，獲得一些不錯的改善後，在今年開始，我真正的將 Instagram App 徹底從我的手機移除，並且嘗試實施了 30 天禁用 Instagram App。

同時，應用部分習慣養成的理論，我在腦中設計了類似日曆鏈 (Calendar Chain)，做法就是想著這樣的行為最終可以讓我獲得一個打叉，這類似於原子習慣中提到的迴紋針策略。(延伸閱讀：[原子習慣：細微改變帶來巨大成就的實證法則 - 我的心得及實作](/atomic-habits-reading-feedback))
...
可能失去了無聊時習慣打發時間的渠道，但相比之下，你改掉睡前滑 Instagram 的習慣、睡眠質量提升、不再一直隨時拿著手機滑滑滑。你也許會明白，**人們並不會因為你不使用社交軟體應用就討厭你，而是在意且你總是輸出他們不是那麼喜歡、需要的內容而討厭你**。
...
因此，在這篇內容中，我與你分享了幾個有關社交軟體成癮和相關的理論。同時，也與你分享了 5 個社交應用軟體成癮現象。並且在這篇內容中，分享了幾項初期可行的解決方式。最後提及了實施 Dopamine Detox / Dopamine Fasting，包含我自己 30 天不使用 Instagram 我自己的一些心得。
