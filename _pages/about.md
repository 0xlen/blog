...
我是 Amazon 的一名雲端工程師 (Amazon Web Services, AWS)，目前主要服務全世界各地使用 AWS 的用戶，協助解決各式各樣困難的技術挑戰。你可以點擊以下連結了解更多我在 AWS EMEA (歐洲) 官方頁面上分享的訪談，了解我及我目前所在的團隊：
...
同時，我過去協助許多重大困難的技術問題，並在 AWS 內部得以認可為全球技術領域專家 (Subject Matter Expert - SME) 且受 Amazon 相關產品團隊開發者認同。目前我被認證為以下 AWS 服務的技術領域專家：
...
在我的工作中，有幸非常多不同規模的客戶業務達到成功，其中包含 Fortune 500 內的公司及擁有上百萬用戶規模的企業。其中也不乏透過提供教育訓練以技術角度向客戶分享更艱澀的問題，協助他們解決許多現實生活中因大規模、或是業務需求等所遭遇的技術挑戰。此外，我同時也在 2019 年獲得台北團隊的 Support MVP 頭銜。
...
我也是一名馬拉松跑者以及潛水員，我擁有 PADI Advanced Open Water (AOW) 進階潛水員及 Enriched Air Diver (EAN) 高氧潛水員執照。工作之餘喜愛力量訓練，並且以作為興趣的方式在經營這些活動。以下是我過去參加的馬拉松及個人紀錄：
...
- 2017
  ...
  - 大三，以實習生 (Intern) 身份加入 Amazon 工作。一年內，通過了 5 個重要的 AWS Certification。[根據非官方的統計](https://www.awshof.com/allstarscertifiedlist.html)，預估是全球前 500 個全數通過五個核心認證的專家，但我想正確的數字應該是全球 1000~2000 名內，你可以在上面搜尋到我。
- 2018
  - 畢業後，正式轉為正職工程師，透過隻身一人到美國出差參加新人教育的機會，在 4 個月內被認可為 ECS SME (November 2018)
- 2019
  - 1 月服兵役，當完繼續回 Amazon 上班
  - 在當兵放假期間，完成與美國的同事完成部落格文章的校稿並公開：[Using AWS Lambda and Amazon SNS to Get File Change Notifications from AWS CodeCommit](https://aws.amazon.com/blogs/devops/using-aws-lambda-and-amazon-sns-to-get-file-change-notifications-from-aws-codecommit/)
- 2020
...
- 2022
  - Accredited as AWS Subject Matter Expert(SME): CodePipeline
